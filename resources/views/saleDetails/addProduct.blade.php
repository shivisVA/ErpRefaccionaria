...
<div class="container mt-4">
    ...
    <div class="card invoice">
        ...
        <div class="card-body p-4 p-md-5">
            ...
            <form action="{{ route('saleDetails.store', $sale->id) }}" method="post">
                @csrf
                <!-- Invoice table-->
                        ...
                        <tbody>
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-right font-weight-bold">
                                    <input class="form-control" id="cant" type="number" name="cantidades[{{  $product->id }}]" value="0">
                                </td>
                                <td class="text-right font-weight-bold">{{ $product->price }}</td>
                               </td>
                                <td>
